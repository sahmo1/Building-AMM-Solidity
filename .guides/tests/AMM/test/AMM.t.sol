...
contract AMMTest is Test,Grading {
    AMM public amm;
	ERC20 public tokenA;
	ERC20 public tokenB;
    ...
    function setUp() public {
		...
		scoreEq( tokenA.balanceOf(address(amm)),amtA );
		scoreEq( tokenB.balanceOf(address(amm)),amtB );
